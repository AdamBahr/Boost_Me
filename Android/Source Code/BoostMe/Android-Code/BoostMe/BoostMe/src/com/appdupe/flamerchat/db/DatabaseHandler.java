...
public class DatabaseHandler {
	...
	public boolean insertMessageData(ChatMessageList objMessageData) {
		...
		try {
			...
			values.put(DatabaseHandler.SENDER_ID,
					objMessageData.getStrSenderFacebookId());
	 ...
	 * matchlist,String usrFacebookId) { // TODO Auto-generated method stub
	 * boolean detailsStored = true; logDebug("insertMatchList");
